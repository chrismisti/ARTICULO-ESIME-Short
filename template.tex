...
\Author{Christian-Antonio Colin-Cejudo$^{1,\dagger,\ddagger}$\orcidA{}, Gonzalo-Issac Duchén-Sánchez $^{2,\ddagger}$\orcidB{} and Gabriel Sánchez-Pérez $^{3,\dagger}$\orcidC{}}
...
\address{%
$^{1}$ \quad  christian.upiita@gmail.com\\
$^{2}$ \quad  gduchen@ieee.org\\
$^{3}$ \quad caaann@gmail.com}
...
\bibitem IEEE Standards Association. (2005). IEEE Standard for SystemVerilog—Unified Hardware Design, Specification, and Verification Language (IEEE Std 1800-2005). IEEE. https://doi.org/10.1109/IEEESTD.2005.93210
